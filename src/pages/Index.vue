      ...
      <main class="mt-14 mb-14">
        <div class="contain flex flex-col gap-7">
          ...
          <p class="text-dimGrey leading-8">
            ...
            <span class="text-border">interactive designs✨</span> with modern
            web technologies. Currently learning backend and databases (<span
              class="text-border"
              >Go🧩</span
            >, <span class="text-border">MongoDB🍃</span>) while also
            solidifying my already acquired knowledge of
            <span class="text-border">front-end🎨</span> development.
          </p>
        ...
        <div class="contain mt-16 flex flex-col gap-3">
          <g-link to="/articles" class="font-semibold">
          Posts <app-icon class="text-dimGrey" icon="link" size="sm"></app-icon>
          </g-link>
          <article
            class="flex items-center gap-10 text-sl"
        ...
        <div class="contain mt-16">
          ...
          <div class="text-dimGrey flex flex-col gap-5">
            <p>
            ...
            <p>
              ...
              <span class="underline underline-offset-4">Vue/Nuxt:</span> An advanced MVVM
              front-end framework
            </p>

            <p>
              <app-icon class="pr-2" icon="fab fa-golang" size="lg"></app-icon>
              <span class="underline underline-offset-4">Go:</span> A statically
              typed and compiled language for backend
            </p>

            <p>
              <app-icon class="pr-2" icon="database" size="lg"></app-icon>
              <span class="underline underline-offset-4">MongoDB:</span> A
              document database that stores data in BSON formart
            </p>
          </div>
        </div>
      </main>
